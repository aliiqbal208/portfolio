...
const SOCIALS = [
  { label: "LinkedIn", href: "https://www.linkedin.com/in/mali/", icon: LinkedinIcon },
  { label: "GitHub", href: "https://github.com/mali", icon: GithubIcon },
  { label: "Twitter", href: "https://twitter.com/mali", icon: TwitterIcon },
  { label: "Instagram", href: "https://www.instagram.com/mali/", icon: InstagramIcon },
];
